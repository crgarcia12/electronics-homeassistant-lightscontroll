...
NoConn ~ 5950 5650
NoConn ~ 5950 5850
Text GLabel 4450 7250 3    50   Input ~ 0
D+
Text GLabel 4350 7250 3    50   Input ~ 0
D-
NoConn ~ 4250 6800
Wire Wire Line
	4150 7100 4450 7100
...
U 1 1 61AE686D
P 4650 7100
F 0 "D7" V 4696 7020 50  0000 R CNN
F 1 "BAT60A-7" V 4605 7020 50  0000 R CNN
F 2 "Diode_SMD:D_SOD-323" H 4650 6925 50  0001 C CNN
F 3 "https://www.infineon.com/dgdl/Infineon-BAT60ASERIES-DS-v01_01-en.pdf?fileId=db3a304313d846880113def70c9304a9" H 4650 7100 50  0001 C CNN
F 4 "C124187" V 4650 7100 50  0001 C CNN "JLCPCB"
	1    4650 7100
	0    -1   -1   0   
$EndComp
$Comp
...
U 1 1 61AE6865
P 4000 6950
F 0 "D4" H 3550 6950 50  0000 C CNN
F 1 "D_TVS" H 4300 6950 50  0000 C CNN
F 2 "Diode_SMD:D_SOD-523" H 4000 6950 50  0001 C CNN
F 3 "~" H 4000 6950 50  0001 C CNN
F 4 "C383211" H 4000 6950 50  0001 C CNN "JLCPCB"
	1    4000 6950
	-1   0    0    1   
$EndComp
$Comp
...
U 1 1 61AE685F
P 4000 7100
F 0 "D5" H 3550 7100 50  0000 C CNN
F 1 "D_TVS" H 4300 7100 50  0000 C CNN
F 2 "Diode_SMD:D_SOD-523" H 4000 7100 50  0001 C CNN
F 3 "~" H 4000 7100 50  0001 C CNN
F 4 "C383211" H 4000 7100 50  0001 C CNN "JLCPCB"
	1    4000 7100
	-1   0    0    1   
$EndComp
$Comp
...
U 1 1 61AE6859
P 4000 7250
F 0 "D6" H 3550 7250 50  0000 C CNN
F 1 "D_TVS" H 4300 7250 50  0000 C CNN
F 2 "Diode_SMD:D_SOD-523" H 4000 7250 50  0001 C CNN
F 3 "~" H 4000 7250 50  0001 C CNN
F 4 "C383211" H 4000 7250 50  0001 C CNN "JLCPCB"
	1    4000 7250
	-1   0    0    1   
$EndComp
$Comp
...
U 1 1 61D7514B
P 4450 6500
F 0 "J3" V 4461 6830 50  0000 L CNN
F 1 "USB_B_Micro" V 4200 6350 50  0000 L CNN
F 2 "Connector_USB:USB_Micro-B_Molex-105017-0001" H 4600 6450 50  0001 C CNN
F 3 "~" H 4600 6450 50  0001 C CNN
F 4 "C132563" H 4450 6500 50  0001 C CNN "JLCPCB"
	1    4450 6500
	0    1    1    0   
$EndComp
$Comp
...
U 1 1 61E5607B
P 4650 7450
F 0 "J12" V 4600 7400 50  0001 R CNN
F 1 "NoCon" V 4600 7450 50  0000 R CNN
F 2 "Connector_PinHeader_2.00mm:PinHeader_1x02_P2.00mm_Vertical" H 4650 7450 50  0001 C CNN
F 3 "~" H 4650 7450 50  0001 C CNN
F 4 "Do Not Connect" V 4550 7350 50  0000 C CNN "Field4"
	1    4650 7450
	0    -1   -1   0   
$EndComp
Wire Wire Line
...
TODO:\n- ESP pinout on the internet looks different than this module. double check\n- Is VIO right? (DevKit does not has it)\n- Should we add jumper or 0Ohm to the BUS->5V? We need to protect the case this cirquit is wrong\n- Do we need resistor in suspend for the CP2102? (check devkit NoConnect resistor)\n- Should USB Shield be connected to GND?
NoConn ~ 4050 6400
$Comp
L Device:CP_Small C6
U 1 1 61EA135E
P 9600 4600
F 0 "C6" H 9800 4550 50  0000 R CNN
F 1 "100nF" H 9850 4650 50  0000 R CNN
F 2 "Capacitor_SMD:C_0603_1608Metric_Pad1.08x0.95mm_HandSolder" H 9600 4600 50  0001 C CNN
F 3 "https://www.distrelec.ch/en/ceramic-capacitor-100nf-50vdc-0805-rnd-components-rnd-1500805b104j500nt/p/30086635?q=smd+capacitor+&pos=5&origPos=990&origPageSize=50&track=true" H 9600 4600 50  0001 C CNN
F 4 "C14663" H 9600 4600 50  0001 C CNN "JLCPCB"
	1    9600 4600
	0    1    1    0   
$EndComp
$Comp
...
U 1 1 61EA5E07
P 10200 5050
F 0 "C17" H 10400 5000 50  0000 R CNN
F 1 "100nF" H 10450 5100 50  0000 R CNN
F 2 "Capacitor_SMD:C_0603_1608Metric_Pad1.08x0.95mm_HandSolder" H 10200 5050 50  0001 C CNN
F 3 "https://www.distrelec.ch/en/ceramic-capacitor-100nf-50vdc-0805-rnd-components-rnd-1500805b104j500nt/p/30086635?q=smd+capacitor+&pos=5&origPos=990&origPageSize=50&track=true" H 10200 5050 50  0001 C CNN
F 4 "C14663" H 10200 5050 50  0001 C CNN "JLCPCB"
	1    10200 5050
	1    0    0    -1  
$EndComp
Wire Wire Line
...
Wire Wire Line
	9700 4600 9700 4650
Text GLabel 10200 5150 3    50   Input ~ 0
GND
